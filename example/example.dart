...
void main(List<String> args) {
  ...
  assert(result.clusters.first.values == [1.0, 2.0, 3.0]);
  assert(result.clusters.last.values == [10.0, 11.0, 12.0]);
  assert(result.clusters.first.mean == 2.0);
  assert(result.clusters.last.mean == 11.0);
  assert(result.clusters.first.elementCount == 3.0);
  assert(result.clusters.last.elementCount == 3.0);
